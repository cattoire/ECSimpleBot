...
bots.set('port', process.env.PORT || 3000);
...
http.createServer(bots).listen(bots.get('port'), '0.0.0.0', function() {
    console.log('Express server listening on port ' + bots.get('port'));
});
